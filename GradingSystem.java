...
public class GradingSystem {
    public static void main(String[] args){
        ...
        char response;
        boolean decision = true, choice = true;
        int option;
        ...
        do{
            ...
            if (option == 1 || option == 2 || option == 3) //the user should only input the given integers in the option
                choice = true; 
            else {
                System.out.println("Invalid. Choose only the given options above.");
                choice = false;
                return;
            }
            ...
            switch (option){
                ...
                case 3: //exit the program 
                    ...
                    if(Grade > PASSING_GRADE){ //evaluates the grade and prints its remarks
                        if(Grade > 5.0)
                            System.out.println("Try again. There is no grade above 5.0");
                        else
